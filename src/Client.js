 ...
 * @param {object} puppeteerBrowser - Puppeteer browser instance (from puppeteer-in-electron)
 * @param {object} browserWindow - Electron BrowserWindow instance
...
class Client extends EventEmitter {
    ...
    async destroy() {
        ...
        // The browser is owned by the Electron app (puppeteer-in-electron),
        // so it is not closed here; the host application controls its lifecycle.
